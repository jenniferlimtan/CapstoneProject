...
import com.example.android.housebillsplitter.MainActivity;
...
public class DetailWidgetProvider extends AppWidgetProvider {
    public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
        ...
        for (int appWidgetId : appWidgetIds) {
            ...
            Intent clickIntentTemplate =  new Intent(context, HousemateBillDetailActivity.class);
    ...
    public void onReceive(@NonNull Context context, @NonNull Intent intent) {
        ...
        if (HouseBillSplitterProvider.ACTION_DATA_UPDATED.equals(intent.getAction())) {
